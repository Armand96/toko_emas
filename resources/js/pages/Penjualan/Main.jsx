...
const Main = ({ setCurentState }) => {
    ...
    const fetchData = async (page = 1, pageSize = 10, filters = {}) => {
        ...
        try {
            ...
            if (filters.status) {
                params.append('approval_status',  filters.status === "CETAK_KWINTANSI" ? "DISETUJUI" : filters.status);
                params.append('status', filters.status === "CETAK_KWINTANSI" ? "DISETUJUI" : filters.status);
            }
