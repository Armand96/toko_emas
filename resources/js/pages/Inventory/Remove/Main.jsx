...
const Main = ({ setCurentState }) => {
    ...
    const [filterData, setFilterData] = useState({ search: urlSearch, status: urlStatus, cabang: urlCabang });
        ...
        <div className="flex flex-col gap-6 w-full">
            ...
            <FilterBar
                ...
                fields={[
                    ...
                    { name: 'status', type: 'dropdown', placeholder: 'Pilih status', options: REMOVE_STATUS_OPTIONS },
